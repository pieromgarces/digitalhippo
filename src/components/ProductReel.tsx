    ...
    return(
        <section className={'py-12'}>
            <div className={'md:flex md:items-center md:justify-between mb-4'}>
                ...
                {href ? (
                    <Link className={'hidden text-sm font-medium text-blue-600 hover:text-blue-500 md:block'} href={href}>Shop the collection {' '}<span aria-hidden={'true'}>&rarr;</span></Link>
                ): null}
            </div>
