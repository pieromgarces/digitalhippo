        ...
        <div className={'mx-auto max-w-2xl px-4 pb-24 pt-16 sm:px-6 lg:max-w-7xl lg:px-8'}>
            ...
            <div className={'mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16'}>
                <div className={cn("lg:col-span-7", {
                    ...
                    <h2 className='sr-only'>Items in your shipping cart</h2>
                                    ...
                                    <div className={'flex-shrink-0'}>
                                        <div className={'relative h-24 w-24'}>
                                            {typeof image !== "string" && image.url ? (
                                                <Image fill src={image.url} alt={'product image'} className={'h-full w-full rounded-nd object-cover object-center sm:h-48 sm:w-48'}/>
                                            ): null}
                                        </div>
                                    </div>
                                            ...
                                            <div>
                                                <div className={'flex justify-between'}>
                                                    <h3 className={'text-sm'}>
                                                        <Link className={'font-medium text-gray-700 hover:text-gray-800'} href={`/product/${product.id}`}>{product.name}</Link>
                                                    </h3>
                                                </div>
