...
const ThankYouPage = async ({searchParams}: PageProps) => {
    ...
    return <main className={'relative lg:min-h-full'}>
        <div className={'hidden md:block h-80 overflow-hidden lg:absolute lg:h-full lg:w-1/2 lg:pr-4 xl:pr-12'}>
            <Image src={'/checkout-thank-you.jpg'} alt={'thank you for your order'} fill
            ...
            <div
                ...
                <div className={'lg:col-start-2'}>
                    ...
                    <div className={'mt-16 text-sm font-medium'}>
                        ...
                        <div
                            className={'space-y-6 border-t border-gray-200 pt-6 text-sm font-medium text-muted-foreground'}>
